# Writing ADRs — AGENTS.md fragment

> Standalone `AGENTS.md` copy of the `writing-adrs` Claude Code skill, for
...
> this fragment in line. No content differs from `SKILL.md`; nothing in it
> was Claude-Code-specific. To use this in another project, see the root
