...
英語スキル(`fable-coding`, `prompting-fable-5`, `injection-vigilance`, `memory-discipline`, `writing-adrs`)には人間用の和訳 `SKILL.ja.md` を併設している(v1.4.0〜)。Claude が読み込むのは `SKILL.md`(英語版)のみ。編集は英語版に行い、和訳を追随させる。
